...
function applyTheme(theme) {
    ...
    if (theme === 'light') {
        ...
        document.querySelectorAll('p, h1, h2, h3, h4, h5, h6, span').forEach(el => el.style.color = '#000000');
        ...
        document.querySelectorAll('p, h1, h2, h3, h4, h5, h6, span').forEach(el => el.style.color = '#ffffff');
